...
# Common path
COMMON_PATH := device/sony/yoshino/external/common
...
$(call inherit-product, device/sony/yoshino/external/common/common-init.mk)
#$(call inherit-product, device/sony/yoshino/external/common/common-odm.mk)
#$(call inherit-product, device/sony/yoshino/external/common/common-odm-camx.mk)
#$(call inherit-product, device/sony/yoshino/external/common/common-odm-mmcam.mk)
$(call inherit-product, device/sony/yoshino/external/common/common-packages.mk)
$(call inherit-product, device/sony/yoshino/external/common/common-perm.mk)
$(call inherit-product, device/sony/yoshino/external/common/common-prop.mk)
$(call inherit-product, device/sony/yoshino/external/common/common-sanitizer.mk)
$(call inherit-product, device/sony/yoshino/external/common/common-treble.mk)
$(call inherit-product, device/sony/yoshino/external/common/common-binds.mk)
